...
<?php
    ...
    else{  header('Location: /AddBook.html');}
	}

else if($act == 'newBookPost'){
  ...
  $courseNumber = mysqli_real_escape_string($con,$courseNumber);
	...
	$sql = "INSERT into bookPost(userName,isbn,title,author,edition,department,courseNumber,newUsed,description,price)
  VALUES('$login_session','$isbn','$title','$author','$edition','$department','$courseNumber','$condition','$description','$price');";
